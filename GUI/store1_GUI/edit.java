...
public class edit extends JFrame implements ActionListener {
    JLabel lb_mant, lb_sonha, lb_duong, lb_phuong, lb_quan, lb_tinh, lb_nql, lb_tt;
    ...
    public edit(store_DTO sto) {
        ...
        tf_sonha.setText(sto.getMasonha());
        ...
        tf_phuong.setText(sto.getPhuong());
        ...
        String manql = sto.getManql();
        System.out.println(manql);
        boolean found = false;
        for (employee_DTO employee : employeelist) {
            if (employee.getManv().equals(manql)) {
                cb_nql.setSelectedItem(employee.getTennv());
                found = true;
                break;
            }
        }
