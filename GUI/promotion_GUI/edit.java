...
public class edit extends JFrame implements ActionListener {
    JLabel lb_makm, lb_tenkm, lb_ngaybd, lb_ngaykt, lb_giam, lb_noidung, lb_diemyc, lb_tt;
    ...
    public edit(promotion_DTO pro) throws ParseException {
        ...
        dateSpinner.setValue(sdf.parse(pro.getNgaybatdau()));
        gbc.gridx = 1;
        gbc.gridy = 2;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        ...
        dateSpinner_1.setValue(sdf.parse(pro.getNgayketthuc()));
        gbc.gridx = 1;
        gbc.gridy = 3;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        ...
        tf_giam.setText(String.valueOf(pro.getGiam()));
        ...
        tf_noidung.setText(pro.getNoidung());
        ...
        tf_diemyc.setText(String.valueOf(pro.getDiem()));
